    ...
    <div class="container">
        ...
        <label>
            <input type="text" title="<fmt:message key="msg.name-validation"/>" maxlength="32"
                   pattern="[A-Za-z\u0400-\u04ff]{1,32}" placeholder="<fmt:message key="msg.name-enter"/>" name="name"
                   required>
        </label>
        ...
        <label>
            <input type="text" title="<fmt:message key="msg.email-validation"/> ivanov@gmail.com" maxlength="45"
                   pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" placeholder="<fmt:message key="msg.email-enter"/>"
                   name="email"
                   required>
        </label>
