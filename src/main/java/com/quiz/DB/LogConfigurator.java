...
public class LogConfigurator {
    ...
    public static Logger getLogger(String contextPath, Class clazz){
        ...
        System.out.println(realPath + "WEB-INF\\classes\\log4j.xml");
        PropertyConfigurator.configure(realPath + "WEB-INF\\classes\\log4j.xml");
        return Logger.getLogger(clazz);
    }

    public static Logger getLogger(Class clazz){
        PropertyConfigurator.configure("C:\\Users\\Oleksandr\\AppData\\Local\\Temp\\Quiz\\src\\main\\resources\\log4j" +
                ".xml");
        return Logger.getLogger(clazz);
    }
